...
public class CreditCardNumberTest {
    ...
    public void validVisaCardWithBlanks() {
        ...
        assertEquals(CreditCardType.VISA, creditCardNumber.getCreditCardType(creditCardNumber.getNumber()));
        assertEquals("123", creditCardNumber.getCvc());
        assertEquals("4321876532147654", creditCardNumber.getNumber());
    }
    ...
    public void validMasterCard() {
        ...
        assertEquals(CreditCardType.MASTERCARD, creditCardNumber.getCreditCardType(creditCardNumber.getNumber()));
        assertEquals("123", creditCardNumber.getCvc());
    ...
    public void throwsInvalidArgumentExceptionWhenNumberIsTooShort() {
        assertThrows(IllegalArgumentException.class, () -> {
           new CreditCardNumber("  53218 76432 1476 ", " 1 2 3 ");
        });
    }
    ...
    public void throwsInvalidArgumentExceptionWhenNumberIsTooLong() {
        assertThrows(IllegalArgumentException.class, () -> {
            new CreditCardNumber("  53218 76432 1476 4445", " 1 2 3 ");
        });
    }
